...
const ConfigureDeezerMusicboxWizard = React.createClass({
  /* **************************************************************************/
  // Class
  /* **************************************************************************/

  displayName: 'ConfigureDeezerMusicboxWizard',
  propTypes: {
      ...
      <div>
        <div style={styles.configurations}>
          <Paper
            ...
            onClick={() => onPickedConfiguration(Configurations[Musicbox.TYPE_DEEZER].DEFAULT_INBOX)}>
            <div>
          ...
          <Paper
            style={styles.configuration}
            onClick={() => onPickedConfiguration(Configurations[Musicbox.TYPE_DEEZER].UNREAD_INBOX)}>
            <div>
          ...
          <Paper
            style={styles.configuration}
            onClick={() => onPickedConfiguration(Configurations[Musicbox.TYPE_DEEZER].PRIORIY_INBOX)}>
            <div>
...
module.exports = ConfigureDeezerMusicboxWizard